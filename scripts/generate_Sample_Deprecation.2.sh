...
do
  ls -1d /nfs/seqscratch_ssd/BCL/*/*/*${line}*fastq.gz >> delFASTQ.step2.txt
  ...
  ls -1d /nfs/seqscratch_ssd/FASTQ/*/GENOME/${line}*/* >> delComponentFASTQ.step6.txt
  ls -1d /nfs/seqscratch_ssd/FASTQ/*/EXOME/${line}*/* >> delComponentFASTQ.step6.txt
  ls -1d /nfs/seqscratch_ssd/FASTQ/*/GENOME_AS_FAKE_EXOME/${line}*/* >> delComponentFASTQ.step6.txt
  #step7 -- 7.	Delete the archived BCL files
# ls -1d /nfs/archive/p2018/BCL/*${flowcellID}*_Unaligned >> delArchivedBCL.step7.txt # we nO longer archive BCL data 
